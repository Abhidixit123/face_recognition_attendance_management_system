...
class Train:
    def __init__(self, root):
        ...
        img_top = Image.open("images/img_3.png")
        ...
        #button
        b1_1 = Button(self.root, text="Train Data",command=self.train_classifier,cursor="hand2", font=("times new roman", 15, "bold"), bg="black",
                      fg="red")
        b1_1.place(x=0, y=380, width=1530, height=60)


        img_bottom= Image.open("images/img_3.png")
